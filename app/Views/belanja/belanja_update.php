...
<div class="main-content bg-white">
    ...
    <form action="" method="post">
        ...
        <input type="hidden" name="id" value="<?= $belanja['bku_id'] ?>" />
        
        <div class="mb-2 row">
            <label for="inputText" class="col-sm-2 col-form-label">Tanggal</label>
            <div class="col-sm-10">
              <input type="text" class="form-control datepicker" autocomplete="off" name="tanggal" id="tanggal" value="<?= $belanja['tanggal'] ?>" required>
            </div>
        </div>
         ...
         <div class="mb-2 row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="uraian" id="uraian" required><?= $belanja['uraian'] ?></textarea>
            </div>
        </div>
